...
// Custom formatter for Buddhist Era
const buddhistFormatters = {
  ...
  formatYearDropdown: (date: Date) => {
    return toBuddhistYear(date).toString()
  },
}

function CalendarBuddhist({
  className,
  classNames,
...
export { CalendarBuddhist, CalendarDayButton, toBuddhistYear, toGregorianYear }
